...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Idg.candidateBundle.Model.map.AuthorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Idg\\candidateBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', 'Idg\\candidateBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
