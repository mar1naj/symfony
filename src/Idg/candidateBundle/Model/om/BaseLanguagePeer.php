...
use Idg\candidateBundle\Model\map\LanguageTableMap;
...
abstract class BaseLanguagePeer
{
    ...
    const OM_CLASS = 'Idg\\candidateBundle\\Model\\Language';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Idg\\candidateBundle\\Model\\map\\LanguageTableMap';
    ...
    const NAME_EN = 'language.name_en';

    /** the column name for the name_or field */
    const NAME_OR = 'language.name_or';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'NameEn', 'NameOr', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nameEn', 'nameOr', ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::NAME_EN, LanguagePeer::NAME_OR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME_EN', 'NAME_OR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name_en', 'name_or', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NameEn' => 1, 'NameOr' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nameEn' => 1, 'nameOr' => 2, ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::NAME_EN => 1, LanguagePeer::NAME_OR => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME_EN' => 1, 'NAME_OR' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name_en' => 1, 'name_or' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LanguagePeer::NAME_EN);
            $criteria->addSelectColumn(LanguagePeer::NAME_OR);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name_en');
            $criteria->addSelectColumn($alias . '.name_or');
        }
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseLanguagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Idg\candidateBundle\Model\map\LanguageTableMap());
      }
    }
